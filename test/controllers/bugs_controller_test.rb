...
class BugsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bug" do
    assert_difference('Bug.count') do
      post bugs_url, params: { bug: { changeset: @bug.changeset, description: @bug.description, rating: @bug.rating, title: @bug.title } }
    end
  ...
  test "should update bug" do
    patch bug_url(@bug), params: { bug: { changeset: @bug.changeset, description: @bug.description, rating: @bug.rating, title: @bug.title } }
